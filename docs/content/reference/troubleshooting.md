...
Most of these come down to network reality or how codecademy serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

codecademy rate-limits like any public site. codecademy already paces
...
Where a surface is gated, codecademy reads a cookie or token you supply
...
`codecademy`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what codecademy actually did
